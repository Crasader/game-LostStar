...
public:
	...
	void* keepData(void *data, size_t length);
    
	/** Intializes with a texture2d with data */
	bool initWithData(const void* data, cocos2d::CCTexture2DPixelFormat pixelFormat, size_t pixelsWide, size_t pixelsHigh, const cocos2d::CCSize& contentSize);
