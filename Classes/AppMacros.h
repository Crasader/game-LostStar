...
static Resource mediumResource =  { cocos2d::CCSizeMake(640,960),  "ipad"   };
static Resource ipadResource =  { cocos2d::CCSizeMake(1024,768),  "normal"   };
static Resource largeResource  =  { cocos2d::CCSizeMake(640*2,960*2), "ipadhd" };
...
static cocos2d::CCSize designResolutionSize = cocos2d::CCSizeMake(640*2,960*2);
