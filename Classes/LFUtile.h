...
extern float minDistanceFromShape(b2Shape *shape, b2Vec2 point,b2Body* shapeBody);
extern float minDistanceFromPolygon(b2Vec2 *vertex, int vertexCount, b2Vec2 point);
extern float minDistanceFromLineSegment(b2Vec2 a, b2Vec2 b, b2Vec2 p);
extern float distance(b2Vec2 p1, b2Vec2 p2);
extern CCPoint getFirstTouchGLPoint(CCSet *pTouches);
